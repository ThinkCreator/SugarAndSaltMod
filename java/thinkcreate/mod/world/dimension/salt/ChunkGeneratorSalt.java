...
import thinkcreate.mod.world.gen.generator.WorldGenStructure;

public class ChunkGeneratorSalt implements IChunkGenerator
{
	   protected static final IBlockState AIR = Blocks.AIR.getDefaultState();
	    protected static final IBlockState BEDROCK = Blocks.BEDROCK.getDefaultState();
	    
	    //Block that is usually Netherrack
	    protected static final IBlockState MAIN_BLOCK = BlockInit.BLOCK_SALT.getDefaultState();
	    ...
	    protected static final IBlockState OTHER_BLOCK2 = BlockInit.BLOCK_ORE_OVERWORLD.getDefaultState();
	    ...
	    */
	    ...
	    public ChunkGeneratorSalt(World world, boolean generate, long seed)
	    {
	        this.world = world;
	    ...
	    public Chunk generateChunk(int x, int z)
	    {
	        ...
	        {
	            abyte[i] = (byte)Biome.getIdForBiome(BiomeInit.SALT_DIMENSION);
	        }
